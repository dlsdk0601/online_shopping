...
import { ResendEmailReqDto, ResendEmailResDto } from "./dto/resend-email.dto";
...
export class SubscribeController {
  ...
  @Post("resend-email")
  @ApiCreatedResponse({ type: ResendEmailResDto })
  async sendEmail(@Body() body: ResendEmailReqDto) {
    return this.subscribeService.sendEmail(body);
  }
}
